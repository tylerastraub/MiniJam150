...
bool Game::loadResources() {
    ...
    if(!SpritesheetRegistry::addSpritesheet(_renderer, SpritesheetID::DEFAULT_TILESET, "res/spritesheet/tileset.png", 16, 16)) return false;
    ...
    if(!SpritesheetRegistry::addSpritesheet(_renderer, SpritesheetID::TORCH, "res/spritesheet/torch.png", 16, 48)) return false;
    if(!SpritesheetRegistry::addSpritesheet(_renderer, SpritesheetID::HEART, "res/spritesheet/heart.png", 16, 16)) return false;
    if(!SpritesheetRegistry::addSpritesheet(_renderer, SpritesheetID::BEACON, "res/spritesheet/beacon.png", 16, 64)) return false;
